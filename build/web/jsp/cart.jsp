            ...
            <table width="100%" border="1" cellspacing="0" cellpadding="3" height="98">
                ...
                <c:forEach var = "item" items="${s_cart}">
                    ...
                    <tr bgcolor="#F0F0F0"> 
                        ...
                        <td width="9%" height="5"> 
                            <input type="text" name=<c:out value="${isbn}"/> size="2" value=<c:out value="${quantity}"/> maxlength="4">
                        </td>
                        ...
                        <td width="11%" height="5"> 
                            <div align="center"> 
                                <input type="checkbox" name="remove" value=<c:out value="${isbn}"/>>
                            </div>
                        </td>
                    </tr>
                </c:forEach>
                <tr bgcolor="#E4E4E4"> 
                    ...
                    <td width="20%" height="2" bordercolor="#CCCCCC"> 
                        <div align="right"><fmt:setLocale value="en_US"/><b>
                            ORDER TOTAL: <fmt:formatNumber value="${totalCostOfOrder}" type="currency"/></b></div>
                    </td>
